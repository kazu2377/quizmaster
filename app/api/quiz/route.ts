...
export async function POST(request: Request) {
  try {
    ...
    // // クイズ保存チェック
    // if (!responseQuiz) {
    //   return NextResponse.json({ message: "クイズが保存できませんでした" }, { status: 404 });
    // }
    ...
    //   const options = shuffle([quiz.option1, quiz.option2, quiz.option3, quiz.answer]);
